...
const CHAT_ROLE_ALLOWLIST: Record<string, string[]> = {
  ...
  REGIONAL_MANAGER: ['SALES_MANAGER', 'SM', 'AGENT'],
  RM: ['SALES_MANAGER', 'SM', 'AGENT'],
  HEAD_OF_TRAINERS: ['TRAINER', 'COO', 'CFO'],
  TRAINER: ['HEAD_OF_TRAINERS', 'SALES_MANAGER', 'SM', 'AGENT'],
  AGENT: ['TRAINER', 'REGIONAL_MANAGER', 'RM', 'SALES_MANAGER', 'SM', 'OPERATIONS_USER'],
};
