-- Migration 048: Backfill default portal users and set Head of Trainers login
-- Ensures all 12 baseline portal users exist.
-- Sets Head of Trainers login to shadrack@techswifttrix.com.
...
BEGIN
  ...
  -- Promote existing legacy HoT login email to the requested account.
  ...
  INSERT INTO users (email, password_hash, full_name, phone, country, role_id, language_preference, timezone)
  VALUES ('shadrack@techswifttrix.com', '$2b$10$vRNeHTi2RxZr7j6fVygzyeMx30FekmoXSHZ8v6qejcFdYwcUPchv2', 'Head of Trainers', '+254700000011', 'Kenya', v_hot_role, 'en', 'Africa/Nairobi')
  ON CONFLICT (email) DO NOTHING;
